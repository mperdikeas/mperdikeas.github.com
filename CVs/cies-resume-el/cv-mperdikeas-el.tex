...
{\bodytext{Ήμουν ο software architect και lead coder για το έργο
    ...
    το οποίο αντικατέστησε το προϋπάρχον σύστημα στην διεύθυνση: \href{registry.euro-vo.org}{registry.euro-vo.org} το οποίο και εξυπηρετούσε την διεθνή \href{http://www.ivoa.net/}{IVOA} κοινότητα για τα τελευταία δέκα (10) χρόνια.
Συνεργάστηκα για τρία χρόνια με ανθρώπους από την TODO - I AM LEFT HERE ΕΧΩ ΜΕΙΝΕΙ ΕΔΩ - 
