...
\newcommand{\technologies}[0]{\textbf{\textit{Τεχνολογίες:}}}
...
\roottitle{Επαγγελματική Εμπειρία} % Top level section

\headedsection % Employer name which can include a hyperlink and location/URL on the right side of the page
    {\href{http://www.esac.com}{Ευρωπαϊκός Οργανισμός Διαστήματος} (μέσω \href{http://www.neuropublic.gr}{Neuropublic})}
{\textsc{European Space Agency / ESAC, Μαδρίτη, Ισπανία}} {

\headedsubsection % Job title entry for the current employer
{Software Architect και Lead Coder}
{Μάρτιος '13 -- Ιανουάριος '16}
{\bodytext{Ήμουν ο software architect και lead coder για το έργο
    ``\href{registry.euro-vo.org}{νέο EuroVO Registry σύστημα}''
    το οποίο αντικατέστησε το προϋπάρχον σύστημα στην διεύθυνση: \href{registry.euro-vo.org}{registry.euro-vo.org} το οποίο και εξυπηρετούσε την διεθνή \href{http://www.ivoa.net/}{IVOA} (International Virtual Obervatory Alliance) κοινότητα για τα τελευταία δέκα (10) χρόνια.
    Συνεργάστηκα για τρία χρόνια με ανθρώπους από την ομάδα Science Archives της ESAC\\
    (\href{http://www.sciops.esa.int/}{http://www.sciops.esa.int/}) (European Space Agency\hairspace{}---\hairspace{}European Space Astronomy Center)
    με ελάχιστη
    έως καθόλου επίβλεψη και σχεδίασα και υλοποίησα από το μηδέν το συνολικό σύστημα με την εξαίρεση του presentation-oriented
    front-end web-based GUI (που υλοποιήθηκε σε GWT\hairspace{}---\hairspace{}\href{http://www.gwtproject.org/}{http://www.gwtproject.org/})
Μεταξύ των άλλων, σχεδίασα και υλοποίησα:
\begin{itemize}
\item όλα τα service-oriented front-end web applications
\item την λειτουργικότητα harvesting σύμφωνα με το πρότυπο OAI-PMH\\ (\href{http://www.openarchives.org/pmh/}{http://www.openarchives.org/pmh/}). Καθώς δεν υπήρχε κάποια αξιόπιστη βιβλιοθήκη που να υλοποιεί αυτό το πρωτόκολλο το ανέπτυξα εξ' ολοκλήρου
  από το μηδέν.
    \technologies{} Java, XPath 2.0 (Saxon), XSLT, REST (Jersey), HTTP, Tomcat 7
  \item την λειτουργικότητα RegTAP σύμφωνα με το πρότυπο \href{http://www.ivoa.net/documents/RegTAP/}{http://www.ivoa.net/documents/RegTAP/}. Μολονότι δεν είχα domain-specific εμπειρία πριν από την είσοδό μου στο project κατάφερα να υλοποιήσω την δεύτερη,
    παγκοσμίως, υπηρεσία RegTAP και να συνεισφέρω ουσιαστικά στην διαμόρφωση του πρωτύπου γεγονός που αναγνωρίστηκε με
    την προσθήκη του ονόματός μου μεταξύ των συγγραφέων του προτύπου.
    \technologies{} Java, XPath 2.0 (Saxon), REST (Jersey), JDBC, Tomcat 7
  \item την διεπαφή αναζήτησης \href{http://www.ivoa.net/documents/RegistryInterface/20091104/REC-RegistryInterface-1.0.pdf}{IVOA RI1}.
    Αυτή είναι μια διεπαφή τύπου \href{https://en.wikipedia.org/wiki/SOAP}{SOAP}, ορισμένη σε WSDL (με άλλα λόγια ακολουθεί μια προσέγγιση top-down). Εξ' αιτίας της πολυπλοκότητας των XSDs που χρησιμοποιούνται από την κοινότητα του IVOA
    αντιμετώπισα προβλήματα με την αυτόματη παραγωγή κώδικα από εργαλεία όπως το 
    \href{https://docs.oracle.com/javase/6/docs/technotes/tools/share/xjc.html}{XJC} (τα οποία έχω τεκμηριώσει
    \href{http://stackoverflow.com/q/17265960/274677}{εδώ} και 
    \href{https://java.net/jira/browse/JAXB-965}{εδώ}). Έτσι αποφάσισα να υλοποιήσω το δικό μου εργαλείο
    στην λογική του
    \href{https://docs.oracle.com/javase/6/docs/technotes/tools/share/wsimport.html}{wsimport}.
    Το εργαλείο αυτό διαβάζει WSDL και ΤΟΔΟTODO EXO MEINE EDO and generates Java code (stubs and skeletons) to perform SOAP calls.\\
