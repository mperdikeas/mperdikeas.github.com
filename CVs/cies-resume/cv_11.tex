...
\begin{multicols}{2}  % Start a two-column layout
  ...
  I have been coding in Java since version JDK 1.1 came out in 1997. Over the years I have written more than 200K
...
{\bodytext{NTUA is the oldest and most prestigious technical university in Greece.
    ...
    code using distributed technologies like CORBA, RMI; code interacting with telecom switch equipment, developed specialized video streaming applications in C++, etc. During that period of time I published more than 14 papers (3 in international refereed journals including IEEE) and the rest in international conferences. Publications
...
{\bodytext{
    ...
    I entered 1st in rank after a nationwide competitive examination and finished 2nd in rank (class size ~150).
