...
{\bodytext{I am working at the {\href{http://cxc.harvard.edu/cda/}{Chandra Data Archive}}
    at the Smithsonian Astrophysical Observatory (Cambridge MA). I am coding primarily in Java and JavaScript but also in Python.
...
{Software design and implementation, alone or in a team. I am a professional Java / JavaScript coder but 
  have also written production code in C, C++ and (more recently) Python and Clojure.
  Also, non-production code in OCaml. I am very comfortable
  at the command line and casually write Bash one-liners daily.
  \underline{Solid knowledge of the following technologies}: Java 7 (SE and EE), Ant/Ivy, HTML/CSS/JavaScript (ECMAScript 2016), ReactJS, Spring Web MVC,
  \acr{XML}, \acr{XPath}, \acr{XSD}, \acr{REST}, \acr{SOAP}, relational databases (Sybase, Oracle, MySQL, PostgreSQL).
  \underline{Administration skills}:\ Linux administration, Bash scripting, Apache Tomcat, JBoss, PostgresSQL.
  \underline{Source control}: ClearCase, Subversion, Git.
}
